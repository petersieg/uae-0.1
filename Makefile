...
.SUFFIXES: .cxx
              ...
              CXX = g++
    CXXDEBUGFLAGS = -pipe -O6 -fomit-frame-pointer
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
  ...
  EXTRA_LIBRARIES =
    ...
    INSTKMEMFLAGS = -m 4755
     ...
     TOP_INCLUDES = -I$(INCROOT)
      ...
      CDEBUGFLAGS = -pipe -O6 -fomit-frame-pointer
        CCOPTIONS =
...
##PSSOXEXTREV = 6.0
##PSDEPLBXXEXTLIB =
##PSLBXXEXTLIB =  -llbxXext

##PSLINTLBXXEXT = $(LINTLIBDIR)/llib-llbxXext.ln

##PSDEPXEXEXTLIB = $(USRLIBDIR)/libXExExt.a
##PSXEXEXTLIB =  -lXExExt

##PSLINTXEXEXT = $(LINTLIBDIR)/llib-lXExExt.ln
...
$(PROGRAM): $(OBJS)
##	$(RM) $@
	$(CXXLINK) -o $@ $(LDOPTIONS) $(OBJS) $(XLIB) $(LDLIBS)  $(LIBS) $(EXTRA_LOAD_FLAGS)
##	g++ -o $@ $(LDOPTIONS) $(OBJS) $(XLIB) $(LDLIBS)  $(LIBS) $(EXTRA_LOAD_FLAGS)
